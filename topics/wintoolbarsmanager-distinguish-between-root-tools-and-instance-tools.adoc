...
The  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.toolbase~isroottool.html[IsRootTool]"]  property of the tool can be used to differentiate between root tools and instance tools. This property will return True if the tool is a root tool and it will return False if the tool is an instance tool.
