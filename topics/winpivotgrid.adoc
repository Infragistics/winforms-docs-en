...
The link:{ApiPlatform}win.ultrawinpivotgrid.v{ProductVersion}~infragistics.win.ultrawinpivotgrid.ultrapivotgrid_members.html[UltraPivotGrid] control provides the ability to present multidimensional (rows and columns) data to an end user.
