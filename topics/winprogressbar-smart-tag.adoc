...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinprogressbar.ultraprogressbar~orientation.html[Orientation]"] 
...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinprogressbar.ultraprogressbar~style.html[Style]"] 
