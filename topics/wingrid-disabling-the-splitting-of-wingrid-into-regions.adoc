...
By default, the WinGrid™ can be split into multiple scroll regions, either by  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridrow.html[Row]"]  or  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn.html[Column]"] .

To prevent the user from splitting the grid via regions, you can set the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridlayout~maxcolscrollregions.html[MaxColScrollRegions]"]  or  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridlayout~maxrowscrollregions.html[MaxRowScrollRegions]"]  properties to 1.
