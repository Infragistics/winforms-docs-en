...
With the release of Office 2010, Microsoft® has introduced a new ribbon style. This release of Infragistics Windows Forms 2010 Volume 3 includes support for the new Office 2010 style Ribbon within our WinToolbarsManager component. A new link:infragistics4.win.v{ProductVersion}~infragistics.win.office2010colortable.html[Office2010ColorTable] has been added to manage all the colors used in this style. A new Pin/Unpin button has been added to the top right corner of the Ribbon, which can be used to collapse/expand the Ribbon.
