...
* *Items collection Add method* - You can add Items to a group by invoking the  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbaritemscollection~add.html[Add]"]  method. The Add method will return the newly added Item, which you can then use to set any Item-related properties. You can also use the Add method to create the new Item with a specific  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbaritem~text.html[Text]"]  and/or Key value.
