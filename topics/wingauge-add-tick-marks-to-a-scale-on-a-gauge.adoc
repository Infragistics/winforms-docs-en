...
[start=1]
. In the Gauges Collection editor window, click the link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgauge~scales.html[Scales] property. Then, click the ellipsis (…) button to open the Scales editor.
[start=2]
. Expand the link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugescale~majortickmarks.html[MajorTickmarks] property. Then click the link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.brushelement.html[BrushElement] property, and from the drop-down list, select Solid Fill.
[start=3]
. Expand the BrushElement property and set the link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.solidfillbrushelement~color.html[Color] property to 189, 189, 189.
[start=4]
...
[start=5]
. Expand the link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugescale~minortickmarks.html[MinorTickmarks] property. Then click the BrushElement property, and from the drop down list, select SolidFill.
