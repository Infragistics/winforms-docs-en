...
To create a fixed (non-scrolling) column, you can use the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.headerbase~fixed.html[Fixed]"]  property of the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.headerbase.html[Header]"]  object.
...
You can also toggle on or off the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.headerbase~fixedheaderindicator.html[FixedHeaderIndicator]"]  in the header, which is displayed by default:
