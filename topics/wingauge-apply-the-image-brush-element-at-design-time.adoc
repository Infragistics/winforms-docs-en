...
[start=4]
. From the   pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.gauge~brushelement.html[BrushElement]"]  drop-down list, select Image Fill. This will create a new Image Fill brush element.
[start=5]
. Click the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.imagebrushelement.html[Image]"]  property, then click the ellipsis button (...).
[start=6]
