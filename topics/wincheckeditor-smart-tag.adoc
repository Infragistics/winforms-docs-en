...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracheckeditor~buttonstyle.html[ButtonStyle]"] 

|Check State
|Determines whether the checkbox is checked, unchecked, or indeterminate.
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracheckeditor~checkstate.html[CheckState]"] 

|Text
|This is the text that will display next to the checkbox.
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracheckeditor~text.html[Text]"] 
...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracheckeditor~style.html[Style]"] 
