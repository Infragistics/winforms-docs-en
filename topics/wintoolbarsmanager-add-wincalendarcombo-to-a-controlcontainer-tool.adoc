...
The WinToolbarsManager™ component has 15 different tool types that you can add to a  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.ultratoolbar.html[ToolBar]"] . This topic demonstrates how to add the WinCalendarCombo to the  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.controlcontainertool.html[ControlContainerTool]"]  design-time and run-time.
...
[start=4]
. Set the  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.controlcontainertool~control.html[Control]"]  property on this tool to the UltraCalendarCombo.
[start=5]
