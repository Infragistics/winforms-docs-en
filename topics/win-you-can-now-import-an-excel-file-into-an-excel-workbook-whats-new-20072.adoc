...
Using the new  pick:[win-forms="link:infragistics4.documents.excel.v{ProductVersion}~infragistics.documents.excel.workbook~load.html[Load]"] method, you can load an Excel file directly into a  pick:[win-forms="link:infragistics4.documents.excel.v{ProductVersion}~infragistics.documents.excel.workbook.html[Workbook]"]  object. You can then manipulate that workbook however necessary, and then use the  pick:[win-forms="link:infragistics4.documents.excel.v{ProductVersion}~infragistics.documents.excel.workbook~save.html[Save]"]  method to save it as an Excel file again. This is extremely useful if you need to make simple and quick modifications to an Excel file. You could even potentially create a data set from the workbook and then use that data in any number of Infragistics Professional controls or components.
