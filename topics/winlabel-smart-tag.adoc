...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.appearance~fontdata.html[Font]"] 
...
| pick:[win-forms="link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.misc.autosizecontrolbase~autosize.html[AutoSize]"] 
