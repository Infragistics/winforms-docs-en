...
This section contains links to specific topics explaining the feature for developing touch-enabled applications using link:{ApiPlatform}win.v{ProductVersion}~infragistics.win.touch.ultratouchprovider.html[UltraTouchProvider] component with the Infragistics controls and components.
