...
This topic illustrates the customization options available to modify the look and user interaction of the chart section of WinGanttView™. The chart section of the control is a type of bar chart that displays tasks and task information. The display of bars in the chart section can be customized through the link:infragistics4.win.ultrawinganttview.v{ProductVersion}~infragistics.win.ultrawinganttview.ultraganttview~timelinesettings.html[TimelineSettings] object. The TimelineSettings object can also be applied to a specific Task.
