...
This topic will show you how to use the  pick:[win-forms="link:infragistics4.win.ultrawintree.v{ProductVersion}~infragistics.win.ultrawintree.ultratreenode~reposition.html[Reposition]"]  method to move a node in a WinTree™ from one parent to another.
