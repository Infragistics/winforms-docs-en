...
. Create a class file named MyGroupByEvaluator that implements IGroupByEvaluator and IGroupByEvaluatorEx interface. This class contains code that implements  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.igroupbyevaluator~getgroupbyvalue.html[GetGroupByValue]"]  and  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.igroupbyevaluator~doesgroupcontainrow.html[DoesGroupContainRow]"]  methods that are member of the IGroupByEvaluator interface and also  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.igroupbyevaluatorex~compare.html[Compare]"]  method that is a member of IGroupByEvaluatorEx interface. Write the following code within MyGroupByEvaluator class.
+
*In Visual Basic:*
[source, vb]
