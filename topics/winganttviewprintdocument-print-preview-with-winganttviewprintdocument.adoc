...
The UltraGanttViewPrintDocument component exposes a link:infragistics4.win.ultrawinganttview.v{ProductVersion}~infragistics.win.ultrawinganttview.ultraganttview_members.html[GanttView] property to which the UltraGanttView control on the form must be assigned.
...
The UltraGanttViewPrintDocument component must be assigned to the link:infragistics4.win.ultrawinprintpreviewdialog.v{ProductVersion}~infragistics.win.printing.ultraprintpreviewdialog~document.html[Document] property of UltraPrintPreviewDialog.
