...
When creating an Outlook Group By grouping in WinGrid™, the area to the left of the expanded groups is known as the GroupByRowConnector. You can style the appearance of the row connectors for the entire control or for specific columns by using the GroupByRowConnectorAppearance property. You can also modify the row connector appearance on the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridgroupbyrow.html[UltraGridGroupByRow]"]  itself in order to style the row connectors for certain rows. This is done through the RowConnectorAppearance property. Additionally, you can style Group By rows themselves through the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~groupbyrowappearance.html[GroupByRowAppearance]"]  property.
