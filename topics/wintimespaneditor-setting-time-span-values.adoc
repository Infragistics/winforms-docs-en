...
The following example code illustrates on setting time span values and formatting them. A specific time span can be set using the TimeSpan property. The minimum and maximum values can be set for the TimeSpanEditor using the link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultratimespaneditor~minvalue.html[MinValue] and link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultratimespaneditor~maxvalue.html[MaxValue] properties. The time span values can be formatted using the link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultratimespaneditor~format.html[Format] property.
