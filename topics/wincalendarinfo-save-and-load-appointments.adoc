...
Using WinCalendarInfo™, you can save and load data to and from a stream. The following code demonstrates how to save and load  pick:[win-forms="link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.appointment.html[Appointments]"] . See the  pick:[win-forms="link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.calendarinfocategories.html[CalendarInfoCategories]"]  enumeration for a list categories that can be used when saving and loading information.
