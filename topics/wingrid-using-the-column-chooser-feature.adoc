...
[start=4]
. You can change the appearance of the button, including the image that's displayed in the button using the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~rowselectorheaderappearance.html[RowSelectorHeaderAppearance]"]  property of the Override.
...
**  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~excludefromcolumnchooser.html[ExcludeFromColumnChooser]"]  - This property is exposed on the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn.html[UltraGridColumn]"]  and  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridband.html[UltraGridBand]"]  objects. It lets you exclude certain columns and bands from appearing in the column chooser. This also means that the user can not hide or unhide these columns and bands.
**  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~columnchoosercaption.html[ColumnChooserCaption]"]  - This property controls the caption of a column when it's displayed in the column chooser.
