...
The following code will programmatically add  pick:[win-forms="link:infragistics4.win.ultrawindatasource.v{ProductVersion}~infragistics.win.ultrawindatasource.ultradataband.html[Bands]"] ,  pick:[win-forms="link:infragistics4.win.ultrawindatasource.v{ProductVersion}~infragistics.win.ultrawindatasource.ultradatacolumn.html[Columns]"]  and  pick:[win-forms="link:infragistics4.win.ultrawindatasource.v{ProductVersion}~infragistics.win.ultrawindatasource.ultradatarow.html[Rows]"]  to an existing WinDataSource™ control, then bind the WinDataSource to an existing WinGrid element.
