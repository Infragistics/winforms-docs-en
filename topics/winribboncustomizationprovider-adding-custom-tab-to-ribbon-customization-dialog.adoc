...
The WinRibbonCustomizationProvider™ component exposes two events, namely link:infragistics4.win.supportdialogs.v{ProductVersion}~infragistics.win.supportdialogs.ribboncustomizationprovider.ultraribboncustomizationprovider~beforecustomizationdialogdisplayed_ev.html[BeforeCustomizationDialogDisplayed] and link:infragistics4.win.supportdialogs.v{ProductVersion}~infragistics.win.supportdialogs.ribboncustomizationprovider.ultraribboncustomizationprovider~aftercustomizationdialogclosed_ev.html[AfterCustomizationDialogClosed], with custom event arguments that expose the ribbon customization dialog in order to modify the dialog. The UltraTabControl is exposed on the dialog, which provides the ability to add custom tabs.
