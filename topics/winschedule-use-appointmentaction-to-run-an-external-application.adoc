...
This topic's content applies to all WinSchedule™ views. The following code demonstrates how to use the  pick:[win-forms="link:{ApiPlatform}win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.appointmentaction.html[AppointmentAction]"]  of an  pick:[win-forms="link:{ApiPlatform}win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.appointment.html[Appointment]"]  to run an external application.
