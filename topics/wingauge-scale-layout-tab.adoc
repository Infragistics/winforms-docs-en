...
The   pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.gaugescale.html[Scale]"]  property of the WinGauge control is used to display a range of values on your Linear or Radial gauge. Adding tick marks to your gauge allows you to visually display the values of the scale on a gauge.
