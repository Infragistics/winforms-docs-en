...
* *Multiple Panel Size Modes --* The  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.ultrastatuspanel.html[UltraStatusPanel]"]  provides a  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.ultrastatuspanel~sizingmode.html[SizingMode]"]  property to determine how the panel is sized. The panel may have a fixed width, be sized based on its contents, expand to fill the available area or allow resizing.
