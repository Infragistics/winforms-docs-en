...
The following code demonstrates how to scroll a day into view for the WinMonthViewSingle and WinWeekView elements utilizing the  pick:[win-forms="link:{ApiPlatform}win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultramonthviewsingle~scrolldayintoview.html[ScrollDayIntoView]"]  method.
