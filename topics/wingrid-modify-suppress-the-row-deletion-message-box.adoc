...
Place this code within the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragrid~beforerowsdeleted_ev.html[BeforeRowsDeleted]"]  event of the WinGrid™ control. This event passes in specific  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.beforerowsdeletedeventargs.html[BeforeRowsDeletedEventArgs]"] .
