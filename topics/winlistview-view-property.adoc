...
The following table lists the enums for the  pick:[win-forms="link:infragistics4.win.ultrawinlistview.v{ProductVersion}~infragistics.win.ultrawinlistview.ultralistviewstyle.html[View]"]  enumeration, along with a brief description of each setting:
