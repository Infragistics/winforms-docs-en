...
Create and add an instance of the link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.ultralivetileview_members.html[UltraLiveTileView] control to the form.
...
Create an instance of a medium live tile. By default, the optional link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tilebase~currentsize.html[CurrentSize] property is set to `Medium`, but best practice dictates that this property be set explicitly.

The available options for link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tilebase~currentsize.html[CurrentSize] property are `Small`, `Medium`, `Wide`, and `Large`.
