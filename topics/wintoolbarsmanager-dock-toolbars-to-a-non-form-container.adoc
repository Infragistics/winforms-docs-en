...
The WinToolbarsManager™ component can create toolbars that dock to containers other than a form. You can take advantage of this feature by using the  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.ultratoolbarsmanager~dockwithincontainer.html[DockWithinContainer]"]  property of the element.
