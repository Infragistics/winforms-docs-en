...
This topic illustrates the Infragistics touch-enabled link:{ApiPlatform}win.ultrawindock.v{ProductVersion}~infragistics.win.ultrawindock.ultradockmanager_members.html[WinDockManager]™ control elements.
