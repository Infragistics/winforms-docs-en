...
To create a consistent look within some applications, you may want to change the look and feel of one of the WinEditor controls. The  pick:[win-forms="link:{ApiPlatform}win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.texteditorcontrolbase~displaystyle.html[DisplayStyle]"]  property allows you selects from OfficeXP, Office2000, VisualStudio2005, Office2007 and many more styles. The following example code shows you how to set the DisplayStyle property use the Office2007 look and feel.
