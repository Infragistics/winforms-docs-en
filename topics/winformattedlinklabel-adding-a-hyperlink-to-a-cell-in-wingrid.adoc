...
.. Find the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~editorcomponent.html[EditorComponent]"]  property in the Properties window and set it to ultraFormattedLinkLabel1.
.. Click Apply, and then OK.
