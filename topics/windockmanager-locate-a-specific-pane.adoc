...
The most common way of locating a pane is by specifying a control. The following code snippet uses the  pick:[win-forms="link:infragistics4.win.ultrawindock.v{ProductVersion}~infragistics.win.ultrawindock.ultradockmanager~panefromcontrol.html[PaneFromControl]"]  method to find a control's DockLocation.
...
You could also use  pick:[win-forms="link:infragistics4.win.ultrawindock.v{ProductVersion}~infragistics.win.ultrawindock.ultradockmanager~panefromkey.html[PaneFromKey]"]  or  pick:[win-forms="link:infragistics4.win.ultrawindock.v{ProductVersion}~infragistics.win.ultrawindock.ultradockmanager~panefromposition.html[PaneFromPosition]"]  methods as well to locate a specific pane.