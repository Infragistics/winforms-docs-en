...
In the Customize editor in the Tools tab select one of your tools and under the  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.sharedprops.html[SharedProps]"]  object there is a property called  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.sharedprops~shortcut.html[Shortcut]"]  where you can set a shortcut or mnemonic key for that tool.
