...
Whenever the user selects a new tab, the element fires the  pick:[win-forms="link:infragistics4.win.ultrawintabcontrol.v{ProductVersion}~infragistics.win.ultrawintabcontrol.ultratabcontrolbase~selectedtabchanging_ev.html[SelectedTabChanging]"]  and  pick:[win-forms="link:infragistics4.win.ultrawintabcontrol.v{ProductVersion}~infragistics.win.ultrawintabcontrol.ultratabcontrolbase~selectedtabchanged_ev.html[SelectedTabChanged]"]  events. You can use these events to determine which tab was selected by the user and take any action you deem necessary.
