...
2. The  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.emptyrowsettings_members.html[EmptyRowSettings]"]  object exposes properties for controlling the appearance of empty rows as well.
