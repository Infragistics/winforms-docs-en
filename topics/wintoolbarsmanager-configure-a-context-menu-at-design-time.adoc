...
[start=3]
. Either select an existing PopupMenuTool from the Current Menu combo box or click the New... button to create a new PopupMenuTool. The listbox below the Current menu combobox displays the current contents of the menu tool's  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.toolscollection.html[Tools]"]  collection.
[start=4]
