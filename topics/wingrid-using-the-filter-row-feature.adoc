...
[start=2]
. To use filter rows you must first enable  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~allowrowfiltering.html[AllowRowFiltering]"] .
...
*  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~filterrowappearance.html[ultraGrid1.DisplayLayout.Override.FilterRowAppearance]"] 
*  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~filterrowappearanceactive.html[ultraGrid1.DisplayLayout.Override.FilterRowAppearanceActive]"] 
*  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~filtercellappearance.html[ultraGrid1.DisplayLayout.Override.FilterCellAppearance]"] 
*  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~filterrowselectorappearance.html[ultraGrid1.DisplayLayout.Override.FilterRowSelectorAppearance]"] 
