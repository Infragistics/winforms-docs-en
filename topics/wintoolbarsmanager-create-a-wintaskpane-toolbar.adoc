...
This dialog is similar to the one presented at run-time from the run-time customize dialog except there is an additional option – "Toolbar Type". By default, this dialog is used to create a standard UltraToolbar type toolbar which is used to host tools such as  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.buttontool.html[ButtonTool]"] ,  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.textboxtool.html[TextBoxTool]"] ,  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.popupmenutool.html[PopupMenuTool]"] , etc. An additional option is available – "TaskPane Toolbar".
