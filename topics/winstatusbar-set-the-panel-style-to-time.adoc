...
The Time panel is used to display the current time. The format of the time display is determined by the  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.ultrastatuspanel~datetimeformat.html[DateTimeFormat]"]  property of the Panel.
...
[start=4]
. Set the  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.ultrastatuspanel~style.html[Style]"]  of the panel to "Time". Click OK.
