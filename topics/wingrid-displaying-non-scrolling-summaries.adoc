...
[NOTE]
====
that the SummaryDisplayArea property is exposed off the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.summarysettings.html[SummarySettings]"]  object as well so different summaries can be displayed in different areas.
====
