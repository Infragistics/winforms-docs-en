...
This topic introduces the Infragistics touch-enabled link:{ApiPlatform}win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.ultratoolbarsmanager_members.html[UltraToolbarsManager]™ and Ribbon elements.
