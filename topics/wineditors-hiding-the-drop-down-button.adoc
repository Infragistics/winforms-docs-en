...
pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.editorwithtextdropdowncontrolbase~dropdownbuttondisplaystyle.html[DropDownButtonDisplayStyle]"]  property makes it possible to prevent the Drop-down button from appearing in the element.
