...
The  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugeneedle~anchor.html[Anchor]"]  property of the WinGauge control is used in connection with the Needle  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugescale~markers.html[Marker]"]  property. An anchor is placed on the center of your Radial gauge so that you can use the anchor as the rotation point of the needle marker.
