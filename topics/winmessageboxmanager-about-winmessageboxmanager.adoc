...
The WinMessageBoxManager™ component enables you to provide information to end users through a message box that can be styled and customized. Information to be displayed in the message box can be defined through an instance of the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultramessagebox.ultramessageboxinfo.html[UltraMessageBoxInfo]"]  object. The key features of the WinMessageBoxManager component are:
