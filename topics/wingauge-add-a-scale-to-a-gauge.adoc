...
[start=1]
. In the Gauges Collection editor window, click the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgauge~scales.html[Scales]"]  property. Then, click the ellipsis button to open the Scales editor.
[start=2]
. In the editor, click Add to add a new Scales.
[start=3]
. Set the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugescale~endangle.html[EndAngle]"]  property to 405.
[start=4]
. Set the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugescale~startangle.html[StartAngle]"]  property to 135.
[start=5]
. Click the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.axis.html[Axis]"]  property. Then, from the drop-down list, select Numeric Axis.
[start=6]
