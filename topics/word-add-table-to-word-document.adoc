...
* link:infragistics4.documents.io.v{ProductVersion}~infragistics.documents.word.tablerowproperties.html[TableRowProperties]
* link:infragistics4.documents.io.v{ProductVersion}~infragistics.documents.word.tablecellproperties.html[TableCellProperties]
* link:infragistics4.documents.io.v{ProductVersion}~infragistics.documents.word.tableborderproperties.html[TableBorderProperties]
...
The code below creates a table with two columns and three rows using the link:infragistics4.documents.io.v{ProductVersion}~infragistics.documents.word.worddocumentwriter.html[WordDocumentWriter] streamer object. The first row is set as a header row using the link:infragistics4.documents.io.v{ProductVersion}~infragistics.documents.word.tablerowproperties~isheaderrow.html[IsHeaderRow] property of the TableRowProperties object.
