...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~displaystyle.html[DisplayStyle]"] 
...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~spinbuttonalignment.html[SpinButtonAlignment]"] 
...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~spinbuttondisplaystyle.html[SpinButtonDisplayStyle]"] 
...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~formatprovider.html[FormatProvider]"] 

|Mask Display Mode
|Use the drop-down to select how the editor should mask the text in the control.
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~maskdisplaymode.html[MaskDisplayMode]"] 

|Mask Input
|This sets the input mask used by the editor.
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultradatetimeeditor~maskinput.html[MaskInput]"] 
