...
This topic demonstrates how to add the link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.ultralivetileview_members.html[UltraLiveTileView]™ control and tiles in an application using the designer interface.
...
1. Create a new Windows forms project and drop the link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.ultralivetileview_members.html[UltraLiveTileView] control from the Toolbox area onto the form or some container.
...
Alternatively, complete the step by right-clicking on the link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.ultralivetileview_members.html[UltraLiveTileView] control and choosing the “ *UltraLiveTileView Designer* ” link.
...
4. Expand the link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.multiresolutiontileimageset~allresolutions.html[AllResolutions] property and click on the image property. This enables the ellipse button (`…`) allowing you to attach an image from your image source.
...
* link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tileframeanimation.html[SlideFromTop]

* link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tileframeanimation.html[SlideFromLeft]

* link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tileframeanimation.html[SlideFromRight]

* link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tileframeanimation.html[SlideFromBottom] (Default)

* link:{ApiPlatform}win.ultrawinlivetileview.v{ProductVersion}~infragistics.win.ultrawinlivetileview.tileframeanimation.html[Fade]
