...
You can use the  pick:[win-forms="link:{ApiPlatform}win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultracalendarinfo~activeday.html[ActiveDay]"]  property off WinCalendarInfo™ to change the active day of all WinSchedule™ controls sharing the same WinCalendarInfo instance.
