...
[start=4]
. From the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.gauge~brushelement.html[BrushElement]"]  drop-down list, select Radial Gradient. This will create a new Radial Gradient brush element.
[start=5]
