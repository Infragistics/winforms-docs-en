...
.. Drag two  pick:[win-forms="link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.misc.ultrabutton.html[UltraButton]"]  controls from the Microsoft® Visual Studio® toolbox into the RowEditTemplate.
