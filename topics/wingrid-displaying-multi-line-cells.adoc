...
[start=2]
. You must set the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~cellmultiline.html[CellMultiLine]"]  property of the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn.html[Column]"]  object to True.
...
[start=3]
. A natural implementation of the CellMultiLine property could be as follows by also setting the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn~vertscrollbar.html[VertScrollBar]"]  property of the column to True.
...
[start=4]
. You may want to increase the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~defaultrowheight.html[DefaultRowHeight]"]  of the grid to better illustrate this sample.
