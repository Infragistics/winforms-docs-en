...
[start=3]
. You can also display a prompt in the template add-row by setting the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~templateaddrowprompt.html[TemplateAddRowPrompt]"]  property.
