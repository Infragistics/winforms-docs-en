...
Using the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.uielement~elementfrompoint.html[ElementFromPoint]"]  method of the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.uielement.html[UIElement]"]  object you can get a cell's value. The following illustrates how to return the value of a cell in response to a double-click, even if the cell is protected.
