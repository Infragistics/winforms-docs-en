...
The WinGanttView™ control provides support for data binding through the link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.projectsdatabinding.html[ProjectsDataBinding] and link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.tasksdatabinding.html[TasksDataBinding] objects. Two new properties were added to the WinCalendarInfo™ component to support data binding, link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultracalendarinfo~databindingsforprojects.html[DataBindingsForProjects] and link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultracalendarinfo~databindingsfortasks.html[DataBindingsForTasks], which are of type ProjectsDataBinding and TasksDataBinding respectively.
