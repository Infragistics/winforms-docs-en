...
[start=3]
. Expand the   pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgauge~dial.html[Dial]"]  property.
[start=4]
. From the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.gauge~brushelement.html[BrushElement]"]  drop-down list, select Multi-Stop Radial Gradient. This will create a new Multi-Stop Radial Gradient brush element.
[start=5]
...
[start=6]
. Click the  pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.multistopradialgradientbrushelement~colorstops.html[ColorStops]"]  property, then click the ellipsis button (...) to open the ColorStops collection editor.
[start=7]
