...
[NOTE]
====
By default the context menu and Task Information dialog can be invoked only from the Grid section of the control. You can allow invoking from different section of the control using the link:infragistics4.win.ultrawinganttview.v{ProductVersion}~infragistics.win.ultrawinganttview.ultraganttview~autodisplaydefaultcontextmenu.html[AutoDisplayDefaultContextMenu] and link:infragistics4.win.ultrawinganttview.v{ProductVersion}~infragistics.win.ultrawinganttview.ultraganttview~autodisplaytaskdialog.html[AutoDisplayTaskDialog] properties.
====
