...
ToolTips have been a staple of quick information-gathering for years now. However, ToolTips tend to appear bland with the same fonts and colors being used time and time again. Formatted ToolTips put an end to this monotony. Using  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.formattedlinklabel.formattedlinkeditor.html[FormattedLinkEditor]"] , our ToolTips can now potentially display simple Web pages.
