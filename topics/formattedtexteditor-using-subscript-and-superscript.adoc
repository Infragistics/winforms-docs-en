...
This topic provides a conceptual overview of how to use subscript and superscript formatting in the link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedtexteditor_members.html[FormattedTextEditor] or link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedlinklabel_members.html[FormattedLinkLabel] controls.
...
Subscript and superscript text may be added to the link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedtexteditor_members.html[FormattedTextEditor] or link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedlinklabel_members.html[FormattedLinkLabel] controls in one of two ways: either using a tag or a style.
...
|Contains general information on formatting text in the link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedtexteditor_members.html[FormattedTextEditor] or link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.formattedlinklabel.ultraformattedlinklabel_members.html[FormattedLinkLabel]
