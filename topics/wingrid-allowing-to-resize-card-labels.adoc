...
You can set how users resize the labels and data cells within the Cards. There are two properties that control this:  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcardsettings~allowlabelsizing.html[AllowLabelSizing]"]  and  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcardsettings~allowsizing.html[AllowSizing]"] .
