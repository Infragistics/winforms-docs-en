...
This topic illustrates the Infragistics touch-enabled link:{ApiPlatform}win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragrid_members.html[WinGrid]™ control elements.
...
Set the filter operator on the link:{ApiPlatform}win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~rowselectors.html[FilterRow] to enable the filter clear button.
...
The following code demonstrates how to enable the link:{ApiPlatform}win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~rowselectors.html[FilterRow] filter operator.
