...
Initialize the cell values of a new row in the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragrid~afterrowinsert_ev.html[AfterRowInsert]"]  event.
