...
The link:{ApiPlatform}win.ultrawinspellchecker.v{ProductVersion}~infragistics.win.ultrawinspellchecker.ultraspellchecker~underlineverticaloffset.html[UnderlineVerticalOffset] property accepts integer value (positive/negative) that allows setting the offset vertically for the underline of the misspelled word.
