...
WinTrackBar includes three styles (set with the  pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultratrackbar~viewstyle.html[ViewStyle]"]  property) that were modeled after separate Microsoft® look and feels:
