...
pick:[win-forms="link:infragistics4.win.ultrawingauge.v{ProductVersion}~infragistics.ultragauge.resources.radialgaugeneedleanchor~extent.html[Extent]"]  -- Set this value to an integer from 0 to 100. If the extent is set to 0, the anchor will be positioned in the center of the Radial gauge. As the value increases the anchor will move towards the edge of the gauge in the direction of the needle. As the value decreases the anchor will move in the opposite direction. If you enter a value greater than 100, the anchor will not appear on the gauge.
