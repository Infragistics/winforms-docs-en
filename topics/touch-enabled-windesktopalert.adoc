...
This topic illustrates the Infragistics touch-enabled link:{ApiPlatform}win.misc.v{ProductVersion}~infragistics.win.misc.ultradesktopalert_members.html[WinDesktopAlert]™ control elements.
