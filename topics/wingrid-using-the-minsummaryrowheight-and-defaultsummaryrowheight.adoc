...
This topic demonstrates the usage of the MinSummaryRowHeight and DefaultSummaryRowHeight properties of the link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragrid_members.html[UltraGrid].
