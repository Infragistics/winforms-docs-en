...
WinToolbarsManager™ includes 15 different tool types that can be added to toolbars and menus. This topic demonstrates how to add a  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.comboboxtool.html[ComboBoxTool]"]  to a toolbar and use a ValueList to populate the combo.
