...
[start=4]
. Set the  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.ultrastatuspanel~style.html[Style]"]  property of the panel to "Marquee". Open the MarqueeInfo property. Select the marquee style you'd like, and set  pick:[win-forms="link:infragistics4.win.ultrawinstatusbar.v{ProductVersion}~infragistics.win.ultrawinstatusbar.marqueeinfo~isactive.html[IsActive]"]  to True.
[start=5]
