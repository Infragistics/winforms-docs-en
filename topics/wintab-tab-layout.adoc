...
This topic shows how you can display Tabs in a single row or in multiple rows using the WinTab™ control’s  pick:[win-forms="link:infragistics4.win.ultrawintabcontrol.v{ProductVersion}~infragistics.win.ultrawintabcontrol.ultratabcontrolbase~tablayoutstyle.html[TabLayoutStyle]"]  property. Also if you display Tabs in multiple rows, you can specify the number of Tabs to be displayed in each row by using the WinTab control’s  pick:[win-forms="link:infragistics4.win.ultrawintabcontrol.v{ProductVersion}~infragistics.win.ultrawintabcontrol.ultratabcontrolbase~tabsperrow.html[TabsPerRow]"]  property.
