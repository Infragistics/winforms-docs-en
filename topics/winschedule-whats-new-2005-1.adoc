...
[NOTE]
====
The Appointment's  pick:[win-forms="link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.appointment~ismultiday.html[IsMultiDay]"]  property takes this into consideration, and would in fact return true in the above scenario.
====
