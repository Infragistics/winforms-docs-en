...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinscrollbar.ultrascrollbar~minmaxbuttonsvisible.html[MinMaxButtonsVisible]"] 
...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinscrollbar.ultrascrollbar~buttonstyle.html[ButtonStyle]"] 

|Orientation
|Select either horizontal or vertical from the drop-down box to display the scroll bar horizontally or vertically.
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinscrollbar.ultrascrollbar~orientation.html[Orientation]"] 
...
| pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ultrawinscrollbar.ultrascrollbar~scrollbararrowstyle.html[ScrollBarArrowStyle]"] 
