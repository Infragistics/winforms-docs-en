...
The WinToolbarsManager™ component has several different tool types that you can add to a toolbar. This topic demonstrates how to add a  pick:[win-forms="link:infragistics4.win.ultrawintoolbars.v{ProductVersion}~infragistics.win.ultrawintoolbars.progressbartool.html[ProgressBarTool]"]  at design time and run time.
