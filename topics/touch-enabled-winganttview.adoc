...
This topic illustrates the Infragistics touch-enabled link:{ApiPlatform}win.ultrawinganttview.v{ProductVersion}~infragistics.win.ultrawinganttview.ultraganttview_members.html[WinGanttView]™ control elements.
