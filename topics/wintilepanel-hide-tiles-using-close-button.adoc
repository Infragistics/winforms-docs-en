...
A close button can be shown on the Tiles at run-time that allows your end users to hide a tile. It can be displayed for a specific tile by setting the  pick:[win-forms="link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.misc.ultratile.html[UltraTile]"]  object’s  pick:[win-forms="link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.misc.ultratilesettings~showclosebutton.html[Settings.ShowCloseButton]"]  property to True or can be displayed on all tiles by setting the  pick:[win-forms="link:infragistics4.win.misc.v{ProductVersion}~infragistics.win.misc.ultratilepanel.html[UltraTilePanel]"]  object’s TileSettings.ShowCloseButton property to True.
