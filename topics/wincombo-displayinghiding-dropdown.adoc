...
The following table lists the drop down button visibility configurable aspects of the WinCombo control through the link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultracombo~dropdownbuttondisplaystyle.html[DropDownButtonDisplayStyle] property.
