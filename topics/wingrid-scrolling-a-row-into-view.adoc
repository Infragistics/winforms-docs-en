...
If you need to scroll a particular row to the top of WinGrid™, you can set the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.rowscrollregion~firstrow.html[FirstRow]"]  property to the desired row.
