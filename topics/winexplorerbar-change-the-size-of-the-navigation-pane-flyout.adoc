...
When the end user clicks the collapsed group, the Navigation Pane flyout opens to a default size and position. However, this default size may be too big or too small for your application's needs. Keep in mind that there is a minimum and maximum size for the Navigation Pane flyout. If you want the flyout to be smaller than the minimum or larger than the maximum, you need to change the  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbar~navigationpaneflyoutminimumsize.html[NavigationPaneFlyoutMinimumSize]"]  and  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbar~navigationpaneflyoutmaximumsize.html[NavigationPaneFlyoutMaximumSize]"]  properties.
...
The following code first sets the minimum size of the Navigation Pane flyout in the form's Load event. The  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.navigationpaneflyoutdisplayingeventargs~preferredsize.html[PreferredSize]"]  is then changed to 75 pixels wide by 150 pixels high in the  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbar~navigationpaneflyoutdisplaying_ev.html[NavigationPaneFlyoutDisplaying]"]  event. This event fires whenever the flyout is about to be displayed, whether it is a result of the end user clicking the group area or a result of the  pick:[win-forms="link:infragistics4.win.ultrawinexplorerbar.v{ProductVersion}~infragistics.win.ultrawinexplorerbar.ultraexplorerbar~shownavigationpaneflyout.html[ShowNavigationPaneFlyout]"]  method being invoked.
