...
In this walkthrough, you will learn how to customize the Focus Rectangle (dotted lines) surrounding an active cell or row by creating a Draw Filter Class that implements the link:infragistics4.win.v{ProductVersion}~infragistics.win.iuielementdrawfilter.html[IUIElementDrawFilter] Interface.
