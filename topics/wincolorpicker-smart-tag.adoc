...
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracolorpicker~color.html[Color]"] 

|Default Color
|Select a default color for the WinColorPicker.
| pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracolorpicker~defaultcolor.html[DefaultColor]"] 
