...
|<p>, <span>, <img>, <br>, <hr>
|Specifies which, if any, gradient to use when drawing a gradient background. Possible values are found in the pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.gradientstyle.html[Infragistics.Win.GradientStyle]"] enumeration.
...
|Border-style
|<p>, <img>
|Specifies which border style to use when drawing a border around an element. Possible values are found in the pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.uielementborderstyle.html[Infragistics.Win.UIElementBorderStyle]"] enumeration.
