...
By default the WinCalendarCombo™ allows the  pick:[win-forms="link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultracalendarcombo~value.html[Value]"]  to be cleared out. The string shown when the Value property has been cleared out is decided based on the  pick:[win-forms="link:infragistics4.win.ultrawinschedule.v{ProductVersion}~infragistics.win.ultrawinschedule.ultracalendarcombo~nulldatelabel.html[NullDateLabel]"]  property. By default it is set to "(none)", though you can change this to whatever you want.
