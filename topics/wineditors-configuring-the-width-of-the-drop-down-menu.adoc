...
The  pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracomboeditor~dropdownlistwidth.html[DropDownListWidth]"]  property makes it possible to explicitly set the width of the drop-down list that appears when the drop-down button is clicked.
