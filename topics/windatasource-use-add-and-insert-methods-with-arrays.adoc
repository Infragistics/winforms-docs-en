...
In 2005 Volume 1, new overloads were added to the  pick:[win-forms="link:infragistics4.win.ultrawindatasource.v{ProductVersion}~infragistics.win.ultrawindatasource.ultradatarowscollection~add.html[Add]"]  and  pick:[win-forms="link:infragistics4.win.ultrawindatasource.v{ProductVersion}~infragistics.win.ultrawindatasource.ultradatarowscollection~insert.html[Insert]"]  methods of the WinDataSource™ component. The new overloads allow you to pass in an array of cell values to initialize a new row.
