...
The UltraTree now supports the ability to bind the tree or a specific nodes collection. The  pick:[win-forms="link:infragistics4.win.ultrawintree.v{ProductVersion}~infragistics.win.ultrawintree.ultratree~datasource.html[DataSource]"]  and  pick:[win-forms="link:infragistics4.win.ultrawintree.v{ProductVersion}~infragistics.win.ultrawintree.ultratree~datamember.html[DataMember]"]  properties of the control can be used to bind the root nodes collection. In addition, the  pick:[win-forms="link:infragistics4.win.ultrawintree.v{ProductVersion}~infragistics.win.ultrawintree.ultratree~setdatabinding.html[SetDataBinding]"]  method of an unbound node's Nodes collection can be used to bind the collection to a datasource providing the ability to display bound data nodes under unbound nodes.
