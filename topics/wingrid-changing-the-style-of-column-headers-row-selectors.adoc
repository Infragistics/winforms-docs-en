...
[start=5]
. In the Override property, scroll down to either the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~headerstyle.html[HeaderStyle]"]  or  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridoverride~rowselectorstyle.html[RowSelectorStyle]"]  properties. Both of these properties have the same four following settings:
