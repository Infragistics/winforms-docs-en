...
The maxOccurs attribute corresponds to the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridband~maxrows.html[MaxRows]"]  property on the *UltraGridBand* class and minOccurs corresponds to the  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridband~minrows.html[MinRows]"]  property.
