...
We added two members to the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ifilterablevaluelist.html[IFilterableValueList]"]  interface:  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ifilterablevaluelist~applyfilter.html[ApplyFilter]"]  and  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ifilterablevaluelist~removefilter.html[RemoveFilter]"] . This interface derives from the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.ivaluelist.html[IValueList]"]  interface, which is implemented by the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.valuelist.html[ValueList]"]  class. If you implemented this interface in your application, the application will fail to compile unless you declare the two new methods.
...
The GlyphStyle property is exposed by the  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.uielementdrawparams.html[UIElementDrawParams]"] ,  pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracheckeditor.html[UltraCheckEditor]"] , and  pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultraoptionset.html[UltraOptionSet]"]  objects. This property allowed you to select which glyphs to use for the WinCheckEditor and WinOptionSet™ controls, choosing between a standard style and the Microsoft® Office® 2007 style.
...
The  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.checkboximageglyphinfo.html[CheckBoxImageGlyphInfo]"]  and  pick:[win-forms="link:infragistics4.win.v{ProductVersion}~infragistics.win.radiobuttonimageglyphinfo.html[RadioButtonImageGlyphInfo]"]  classes both contain image properties for WinCheckEditor and WinOptionSet, respectively. These image properties were all gettable and settable; however, we have modified these properties to be read-only and added constructors to allow you to pass in images for various states of the glyphs.
...
The AutoEdit property exposed by the  pick:[win-forms="link:infragistics4.win.ultrawineditors.v{ProductVersion}~infragistics.win.ultrawineditors.ultracomboeditor.html[UltraComboEditor]"] ,  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultracombo.html[UltraCombo]"] , and  pick:[win-forms="link:infragistics4.win.ultrawingrid.v{ProductVersion}~infragistics.win.ultrawingrid.ultragridcolumn.html[UltraGridColumn]"]  objects has been deprecated in favor of the new AutoCompleteMode property.
