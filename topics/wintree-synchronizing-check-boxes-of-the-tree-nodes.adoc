...
* Applies to nodes appearing in front of a result of the link:{ApiPlatform}win.ultrawintree.v{ProductVersion}~infragistics.win.ultrawintree.override~nodestyle.html[NodeStyle] property
